...
# 👩‍💼 HR — Vận hành trên Desk

> Dành cho **HR Manager** dùng giao diện **Desk** (`/app`) để xử lý công việc chấm công & nghỉ phép **hằng ngày**. Phần cấu hình hệ thống (Employee, ca, văn phòng, chính sách…) xem **[🛠️ Quản trị (cấu hình)](HD-QuanTri.html)**.
...
> 💡 **Vào Desk:** `working.thegioidiengiai.com/app` — đăng nhập tài khoản có role **HR Manager**. Gõ tên doctype vào ô **Search** (Ctrl/⌘ + G) để mở nhanh bất kỳ danh sách nào.
