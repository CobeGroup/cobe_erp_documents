...
| Tình huống | Cách xử |
|---|---|
| Không thấy tab "Cần duyệt" | Tab hiện theo role **Leave Approver** (hoặc HR Manager / System Manager) — báo HR cấp role đó + gán đúng phòng |
| Thấy đơn chấm công bù nhưng bấm **Duyệt** báo thiếu quyền | Cần thêm role **Attendance Request Approver** (role này mới có quyền duyệt xong đơn chấm công bù) — báo HR |
