...
| Không thấy nút **Vận đơn ĐVVC** ở đâu cả, và cũng không thấy khối theo dõi vận đơn | Tài khoản không có quyền tạo Vận đơn (`DP Shipment`). Nút và khối trạng thái đều ẩn theo quyền — nhờ quản trị cấp role **DP Operator** hoặc **DP Manager**. |
