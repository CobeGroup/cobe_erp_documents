...
1. **Overtime (OT)** ✅ *đã chạy* — NV xin làm thêm (PWA) → duyệt **2 cấp**: trưởng bộ phận rồi HR → đối chiếu chấm công → **Overtime Slip** → `Additional Salary` gộp vào Salary Slip kỳ tới. Quy đổi được **tiền** hoặc **nghỉ bù**.
